...
const dataInicial = [
  ...
  { id:5, nombre:"Kit frenos CASE", cantidad:5, precio:"$3,400", proveedor:"CASE Distribuidores", compatible:"CASE 1107F", stock:"OK" },
  { id:6, nombre:"Grasa multiusos", cantidad:20, precio:"$180", proveedor:"Lubricantes del Norte", compatible:"General", stock:"OK" },
  { id:7, nombre:"Manguera hidráulica", cantidad:1, precio:"$1,700", proveedor:"HidroMax MX", compatible:"CAT 950GC, CAT 320", stock:"Crítico" },
];
  ...
  return (
    <div style={styles.page}>
      <div style={styles.topbar}>
        <div>
          <p style={styles.pageTag}>Inventario</p>
          <h1 style={styles.title}>Refacciones</h1>
        </div>
        <div style={styles.topbarRight}>
          <div style={styles.searchBox}>
            <span className="material-icons" style={styles.searchIcon}>search</span>
            <input style={styles.searchInput} placeholder="Buscar refacciones..." value={q} onChange={e => setQ(e.target.value)} />
          </div>
      ...
      <div style={styles.miniGrid}>
        {[
          { label:"Total piezas", value:data.length, icon:"inventory_2", color:"#1d1d1f" },
      ...
      <div style={styles.card}>
        <div style={styles.cardHeader}>
          <div style={styles.cardHeaderLeft}>
            <span className="material-icons" style={{ fontSize:18, color:"#00b4d8" }}>inventory_2</span>
            <div style={styles.cardTitle}>{filtrados.length} refacciones</div>
          </div>
        </div>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="Nueva Refacción">
        <FormGrid>
          <FormGroup label="Nombre *">
            <Input name="nombre" value={form.nombre} onChange={handleChange} placeholder="Filtro hidráulico" />
          </FormGroup>
          ...
          <FormGroup label="Proveedor">
            <Input name="proveedor" value={form.proveedor} onChange={handleChange} placeholder="CAT Parts MX" />
          </FormGroup>
          <FormGroup label="Compatible con">
            <Input name="compatible" value={form.compatible} onChange={handleChange} placeholder="CAT 320, CAT 140M" />
          </FormGroup>
